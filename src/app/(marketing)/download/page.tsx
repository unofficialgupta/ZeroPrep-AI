  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      if (ua.includes('win')) {
        ...
        // macOS - default to Apple Silicon
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="rounded-xl border border-amber-200 bg-amber-50/50 p-5">
              ...
              <p className="mt-2 text-xs text-amber-800 leading-relaxed">
                Because ZeroPrep AI is distributed directly as an open-architecture binary without expensive Apple Developer notarization certificates, macOS may show an &quot;unidentified developer&quot; or &quot;app is damaged&quot; notice upon first opening.
              </p>
              <div className="mt-3">
        ...
        <div className="mt-10 rounded-2xl border border-slate-200 bg-slate-50/60 p-8">
          ...
          <p className="mt-1 text-xs text-slate-500">
            ZeroPrep AI requires two standard OS permissions to function during technical rounds:
          </p>
